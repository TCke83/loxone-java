...
public abstract class Control {
    ...
    /**
     * Helper to check if the Control is lockable.
     *
     * @return true if the control supports locking, false otherwise.
     */
    public boolean isLockable() {
        return states != null && states.containsKey(STATE_JLOCKED);
    }
}
